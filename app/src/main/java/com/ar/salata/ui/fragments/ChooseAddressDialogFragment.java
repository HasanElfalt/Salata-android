...
public class ChooseAddressDialogFragment extends DialogFragment {
	...
	String[] dayList = {"السبت", "الاحد", "الاثنين", "الثلاثاء", "الاربعاء", "الخميس", "الجمعة"};
	String[] addressList = {"العنوان الثاني", "العنوان الثالث", "العنوان الاول"};
	String[] timeList = {ArabicString.toArabic("01:00 ظهرا"), ArabicString.toArabic("03:00 عصرا"), ArabicString.toArabic("05:00 عصرا")};
