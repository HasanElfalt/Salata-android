...
import static com.ar.salata.ui.fragments.ChooseAddressDialogFragment.DELIVERY_HOUR_FROM;
import static com.ar.salata.ui.fragments.ChooseAddressDialogFragment.DELIVERY_HOUR_To;
...
public class AddToCartActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        order = new Order(intent.getIntExtra(SHIFT_ID, 1),
                ...
                intent.getStringExtra(DELIVERY_HOUR_FROM),
                intent.getStringExtra(DELIVERY_HOUR_To));
